...
%   FILENAME = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   FILENAME = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   FileName = importfile('15.txt', 1, 44);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/04/17 16:43:26
